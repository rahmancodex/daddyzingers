  ...
  return (
    <header
      className={`sticky top-0 inset-x-0 z-50 transition-all duration-500 ${
        scrolled
          ? "bg-background/80 backdrop-blur-2xl border-b border-border/80 shadow-[var(--shadow-2)]"
          : "bg-background/60 backdrop-blur-xl border-b border-border/40"
      }`}
    >
      <div className="container-dz flex items-center gap-2 md:gap-4 h-16 md:h-[72px]">
        {/* Logo */}
        <Link to="/" className="flex items-center gap-2.5 md:gap-3 shrink-0 group" aria-label="Daddy Zinger — Home">
          <div className="relative h-10 w-10 md:h-11 md:w-11 rounded-2xl overflow-hidden ring-1 ring-primary/25 shadow-[var(--shadow-glow)] group-hover:ring-primary/60 group-hover:scale-[1.04] transition-all">
        ...
        <button
          ...
          className="relative inline-flex items-center gap-2 h-10 md:h-11 pl-3 pr-3.5 md:pr-4 rounded-full bg-primary text-primary-foreground font-semibold text-sm shadow-[var(--shadow-glow)] hover:scale-[1.04] active:scale-[0.98] transition-transform"
      ...
      {/* Mobile row: method toggle + branch */}
      <div className="md:hidden container-dz pb-2.5 -mt-1 flex items-center gap-2">
